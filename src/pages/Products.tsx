  ...
  const products: { key: string; icon: LucideIcon; specs: string[] }[] = [
    {
      key: 'sheets',
      icon: Layers,
      specs: ['Толщина: 0,5 - 16 мм', 'Ширина: до 450 мм', 'Марки М1, М2, М3'],
    },
    {
      key: 'strips',
      icon: ScrollText,
    ...
    },
    {
      key: 'foil',
      icon: Ribbon,
      specs: ['Толщина: 0,035 - 0,15 мм', 'Ширина: 10 - 450 мм', 'В рулонах или листах'],
    },
    {
      key: 'brassSheets',
      icon: Layers,
    ...
    },
    {
      key: 'brassStrips',
      icon: Ribbon,
      specs: ['Толщина: 0,16 - 16 мм', 'Ширина: до 450 мм'],
    },
    {
      key: 'brassFoil',
      icon: ScrollText,
      specs: ['Толщина: 0,035 - 0,15 мм', 'Ширина: до 450 мм'],
    },
  ];
