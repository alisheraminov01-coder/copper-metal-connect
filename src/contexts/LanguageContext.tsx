...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'products.copperStrips': 'Полосы медные',
    'products.copperStrips.desc': 'Медные полосы для электротехнической промышленности',
  ...
  en: {
    ...
    'products.copperStrips': 'Copper Strips',
    'products.copperStrips.desc': 'Copper strips for electrical industry',
  ...
  uz: {
    ...
    'products.copperStrips': 'Mis polosalari',
    'products.copperStrips.desc': 'Elektrotexnika sanoati uchun mis polosalari',
